...
(MAG-TRC engineering) get Blue; **runtime-plane** nodes keep their status colour. **Current** nodes get a solid
...
5. Mark human-approval edges/nodes (those touching MAG-GOV approval) distinctly (e.g. Blue border).
