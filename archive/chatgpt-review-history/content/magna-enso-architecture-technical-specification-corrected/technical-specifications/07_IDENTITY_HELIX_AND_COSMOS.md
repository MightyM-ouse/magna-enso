...
## Human ToC
1. Purpose/Scope/Non-goals 2. Identity (MAG-IDN-001) 3. HELIX read-only (MAG-HLX-001) 4. Cosmos ratification (MAG-COS-001)
...
## 2. Identity (MAG-IDN-001, MAG-FR-011)
...
## 3. HELIX read-only (MAG-HLX-001, MAG-FR-012)
...
## 4. Cosmos ratification (MAG-COS-001, MAG-FR-013)
